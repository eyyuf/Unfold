...
from experiments.models import DailyTask, Experiment, ExperimentTrait, ExperimentTraitWeight, SavedExperiment, UserExperiment
...
class ExperimentTraitSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ["id", "slug", "name", "description", "positive_hypothesis_text", "negative_hypothesis_text", "is_active"]
...
class ExperimentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Experiment
        fields = ["id", "category", "title", "slug", "description", "duration_days", "minutes_per_day", "daily_tasks", "trait_weights"]
...
class CheckInSerializer(serializers.ModelSerializer):
    motivation_before = serializers.IntegerField(min_value=1, max_value=5, required=False, allow_null=True)
    enjoyment = serializers.IntegerField(min_value=1, max_value=5, required=False, allow_null=True)
    energy_after = serializers.IntegerField(min_value=1, max_value=5, required=False, allow_null=True)
    curiosity = serializers.IntegerField(min_value=1, max_value=5, required=False, allow_null=True)
    meaning = serializers.IntegerField(min_value=1, max_value=5, required=False, allow_null=True)
    desire_to_continue = serializers.IntegerField(min_value=1, max_value=5, required=False, allow_null=True)
    desire_to_improve = serializers.IntegerField(min_value=1, max_value=5, required=False, allow_null=True)
    lost_track_of_time = serializers.IntegerField(min_value=1, max_value=5, required=False, allow_null=True)
    difficulty = serializers.IntegerField(min_value=1, max_value=5, required=False, allow_null=True)
    satisfaction_after = serializers.IntegerField(min_value=1, max_value=5, required=False, allow_null=True)
...
class UserHypothesisSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "trait", "support_score", "confidence_score", "evidence_count", "status", "status_display", "updated_at"]
...
class PatternDefinitionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "slug", "title", "description", "traits", "min_experiments", "min_fit_score", "positive_text", "is_active"]

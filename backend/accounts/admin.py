...
class UnfoldUserAdmin(UserAdmin):
    ordering = ("email",)
    list_display = ("email", "display_name", "is_staff", "reminders_enabled", "date_joined")
    ...
    fieldsets = (
        ...
        ("Unfold", {"fields": ("display_name", "timezone", "reminder_time", "reminders_enabled", "email_reminders_enabled", "analytics_consent", "onboarding_answers", "terms_accepted_at")}),
    )
    add_fieldsets = (

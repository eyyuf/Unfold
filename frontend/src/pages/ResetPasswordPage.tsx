  ...
  return (
    ...
    >
      <Card className="auth-card" style={{ width: '100%', maxWidth: 440, padding: 32 }}>
        ...
        <p style={{ color: C.t3, marginBottom: 22 }}>
          Use at least 8 characters and avoid common passwords.
        </p>
        {!reset.isSuccess ? (
          <>
            <label style={{ display: 'block', color: C.t2, fontSize: 14, marginBottom: 16 }}>
              New password
              <input
                type="password"
            ...
            <label style={{ display: 'block', color: C.t2, fontSize: 14, marginBottom: 16 }}>
              ...
              <input
                ...
                style={{
                  ...
                  background: C.s2,
                  color: C.t1,
                  border: `1px solid ${mismatch ? C.red : C.br}`,
                  borderRadius: 10,
                  padding: '12px 14px',
                  font: 'inherit',
                }}
          ...
          <>
            <p role="status" style={{ color: C.acc }}>
              {reset.data.detail}
            </p>
            <Btn full onClick={() => setScreen('login')}>
              Continue to login
            </Btn>
          </>
        )}

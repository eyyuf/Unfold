    ...
    <div style={{ background: C.bg, minHeight: '100vh', color: C.t1 }}>
      ...
      >
        ...
        <nav style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          <Btn variant="primary" size="sm" onClick={() => setScreen('register')}>
            Start free
          </Btn>
        </nav>
      </header>
      ...
      {/* Hero */}
      <section
        className="landing-hero gradient-bg"
        style={{
          maxWidth: 1200,
          margin: '0 auto',
      ...
      >
        <div className="fade-up">
          ...
          <h1
            className="stagger-2 font-serif"
            style={{ fontSize: 54, lineHeight: 1.1, marginBottom: 20 }}
          >
            Discover yourself
            <br />
          ...
          <p
            className="stagger-3"
            style={{ fontSize: 18, color: C.t2, lineHeight: 1.65, maxWidth: 480, marginBottom: 36 }}
          >
            Try short activities, record how they feel, and uncover patterns about what energizes
            you, matters to you, and deserves more of your attention.
          </p>
          ...
          <div style={{ marginTop: 32, display: 'flex', gap: 24 }}>
            {[
              { v: 'Short', l: 'real-world trials' },
              { v: 'Daily', l: 'honest check-ins' },
              { v: 'Private', l: 'personal evidence' },
            ].map(({ v, l }) => (
              <div key={l}>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Sparkles size={12} /> EVIDENCE FORMING
                </span>
                <span style={{ fontSize: 12, color: C.t3 }}>Day 3 of 7</span>
              </div>
              <div
                className="font-serif"
                style={{ fontSize: 16, color: '#F1F0E9', marginBottom: 8 }}
              >
                Photography Walk
              </div>
      ...
      <section style={{ maxWidth: 1200, margin: '0 auto', padding: '60px 40px' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          <h2 style={{ fontSize: 34, fontWeight: 700, marginBottom: 12, letterSpacing: '-0.02em' }}>
            How it works
          </h2>
          ...
          {[
            {
              n: '01',
              title: 'Choose',
              desc: 'Pick one short experiment from our library — writing, photography, teaching, coding, and more.',
              color: C.purple,
              Icon: Compass,
            },
            {
              n: '02',
              title: 'Try',
              desc: 'Complete small real-world tasks each day and record how the activity felt — not how you wish it felt.',
              color: C.acc,
              Icon: Play,
            },
            {
              n: '03',
              title: 'Discover',
              desc: 'Review evidence from your own behavior. Detect patterns across experiments and see what deserves more attention.',
              color: C.blue,
              Icon: BarChart2,
            },
            ...
            <Card key={title} style={{ background: C.s1 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                ...
                <span
                  style={{ fontSize: 12, fontWeight: 700, color: C.t4, letterSpacing: '0.05em' }}
                >
                  {n}
                </span>
              </div>
      ...
      <section style={{ maxWidth: 1200, margin: '0 auto', padding: '20px 40px 60px' }}>
        ...
        <div
          className="experiment-grid-landing"
          style={{
            display: 'grid',
          ...
          {experiments.map(({ title, cat, color, duration, time, Icon }) => (
            <Card key={title} onClick={() => setScreen('login')} style={{ cursor: 'pointer' }}>
              ...
              >
                ...
                <span aria-hidden="true" style={{ color: C.t4 }}>
                  <Bookmark size={15} />
                </span>
              </div>
              <Badge label={cat} color={color} />
              <h3 style={{ fontSize: 15, fontWeight: 700, margin: '10px 0 8px', lineHeight: 1.35 }}>
                {title}
              </h3>
      ...
      >
        <div style={{ maxWidth: 700, margin: '0 auto', padding: '64px 40px', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: 16, color: C.t2, lineHeight: 1.7 }}>
            This is not a personality test, life verdict, or career oracle. It is a practical tool
            for learning from your own lived experience — one small experiment at a time.
          </p>
        </div>
      </section>
      ...
      {/* Final CTA */}
      <section
        style={{ maxWidth: 700, margin: '0 auto', padding: '80px 40px', textAlign: 'center' }}
      >
      ...
      >
        <span style={{ fontSize: 13, color: C.t4 }}>
          Copyright {new Date().getFullYear()} Unfold
        </span>

    ...
    <div className="modal-backdrop" onClick={onCancel}>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 10, marginTop: children ? 20 : 0 }}>
          ...
          <Btn variant={confirmVariant} full onClick={onConfirm}>
            {confirmLabel}
          </Btn>
        </div>
      </div>
...
export function SkeletonCard() {
  return (
    ...
    >
      ...
      <div
        className="skeleton"
        style={{ width: '75%', height: 16, borderRadius: 6, marginBottom: 10 }}
      />
      <div
        className="skeleton"
        style={{ width: '100%', height: 14, borderRadius: 6, marginBottom: 6 }}
      />
...
export function LoadingBlock({ label }: { label: string }) {
  return (
    <div
      role="status"
      aria-live="polite"
      style={{ maxWidth: 680, margin: '60px auto', padding: 24 }}
    >
      <div
        className="skeleton"
        style={{ width: '42%', height: 24, borderRadius: 8, marginBottom: 14 }}
      />
      <div
        className="skeleton"
        style={{ width: '100%', height: 120, borderRadius: 14, marginBottom: 12 }}
      />
...
export function ErrorBlock({ message, onRetry }: { message: string; onRetry: () => void }) {
  return (
    <div
      role="alert"
      style={{ maxWidth: 560, margin: '70px auto', padding: 24, textAlign: 'center' }}
    >
...
export function EmptyState({
  ...
  return (
    <div style={{ maxWidth: 580, margin: '60px auto', padding: '36px 32px', textAlign: 'center' }}>
...
export function Card({
  ...
  const base: React.CSSProperties = {
    ...
    transition:
      'transform 0.2s cubic-bezier(0.22, 1, 0.36, 1), box-shadow 0.2s ease, border-color 0.2s ease',
    ...style,
  }
  ...
  return (
    ...
    >
      <span
        ...
        style={{ color, background: `${color}18`, borderColor: `${color}42` }}
      >
...
export function ScoreBar({ label, value }: { label: string; value: number }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
      ...
      <span style={{ width: 36, fontSize: 13, color: C.t3, textAlign: 'right', flexShrink: 0 }}>
        {value}%
      </span>
    </div>
  )
